...
class GridViewBuilderPopular extends StatelessWidget {
  const GridViewBuilderPopular({Key? key, required this.blockCount})
      : super(key: key);
...
class _MoviesGridViewContainerState extends State<MoviesGridViewContainer> {
  ...
  void initState() {
    ...
    upcomingMovies = repo.loadPopularMovies();
  }
